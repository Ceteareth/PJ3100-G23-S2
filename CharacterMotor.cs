...
public class CharacterMotor : MonoBehaviour
{
	...
	bool activeSprint = false;
	public float sprintCoefficient = 10.0f;
	public int sprintDuration = 5;
	public int sprintCooldown = 10;
	...
	{
		activeSprint = true;
		movement.maxForwardSpeed *= sprintCoefficient;
		movement.maxSidewaysSpeed *= sprintCoefficient;
		movement.maxBackwardsSpeed *= sprintCoefficient;
    ...
    void Update()
    {
		if(Input.GetKeyDown(KeyCode.LeftShift) && !activeSprint){
